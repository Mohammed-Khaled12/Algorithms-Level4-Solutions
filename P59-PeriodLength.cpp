...
int main()
{
    ...
    cout << "Period Length is: " << GetDifferenceInDays(Period1Start, Period1End) << "\n";
    cout << "Period Length (Including End Date) is: " << GetDifferenceInDays(Period1Start, Period1End, true) << "\n";
