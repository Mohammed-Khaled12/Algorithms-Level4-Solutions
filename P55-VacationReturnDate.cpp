...
stDate VactionReturnDate(stDate StartDate, int VactionDays)
{
    while (VactionDays != 0)
    {
...
int main()
{
    ...
    stDate EndDate;
    int VacationDays = readNumber("Vacation Days");

    EndDate = VactionReturnDate(StartDate, VacationDays);
    cout << "Return Date: " << DayShortName(DayOfWeekOrder(EndDate));
